...
# source_id = "UTB00180"
class DataCitationIndex(TestBase):
    @pytest.fixture(autouse=True)
    def setup(self, page: Page):
        super(DataCitationIndex, self).setup(page, "UTB00180")

    def test_wayf(self):
        super(DataCitationIndex, self).wayf()
    ...
    def test_wayfless(self):
        super(DataCitationIndex, self).wayfless()

    def test_proxy_shibboleth(self):
        super(DataCitationIndex, self).proxy_shibboleth()
        self.assert_access()

    def test_proxy_ldap(self):
        super(DataCitationIndex, self).proxy_ldap()
        self.assert_access()

    @pytest.mark.vpn
    def test_vpn(self):
        super(DataCitationIndex, self).vpn()
        self.page.goto(self.e_source.link_native_home)
        self.assert_access()
